...
<div class="content-wrapper">
    <div class="justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header"><b>Edit Delivery Boy</b>
                <span class="float-right">
                    <a class="btn btn-primary" href="{{ route('deliveryBoy.index') }}">Delivery Boys</a>
                </span>
            </div>

            <div class="card-body">
                {!! Form::model($user, ['route' => ['deliveryBoy.update', $user->id], 'method'=>'PATCH']) !!}
