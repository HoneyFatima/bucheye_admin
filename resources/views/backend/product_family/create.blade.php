...
<div class="content-wrapper">
    <div class="justify-content-center">
        ...
        @endif
        <div class="card">
            <div class="card-header"><b>Create Product Family</b>
                <span class="float-right">
                    <a class="btn btn-primary" href="{{ route('category.index') }}">Product Families</a>
                </span>
            </div>
            <div class="card-body">
                {!! Form::open(array('route' => 'product-family.store','method'=>'POST','enctype'=>'multipart/form-data')) !!}
